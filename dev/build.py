    ...
    def compile_py_files(self):
        ...
        for root, dirs, files in os.walk(self.build_dir):
            for file in files:
                ...
                # or that start with "Ram_Intercept" (copied as .py, not compiled)
                if file.endswith(".py"):
                    ...
                    if name_noext.lower().endswith("viper"):
                        ...
                        continue
                    if name_noext.startswith("Ram_Intercept"):
                        # leave the .py file in place and skip compiling
                        print(f"Skipping Ram_Intercept file: {os.path.join(root, file)}")
                        continue
