...
- **Handler:** [`get_challenge`](https://github.com/warped-pinball/vector/blob/main/src/common/backend.py#L347)
...
- **Handler:** [`check_password`](https://github.com/warped-pinball/vector/blob/main/src/common/backend.py#L389)
...
- **Handler:** [`app_reboot_game`](https://github.com/warped-pinball/vector/blob/main/src/common/backend.py#L425)
- Authentication: Required (see [Authentication guide](authentication.md)).
...
- **Handler:** [`app_game_name`](https://github.com/warped-pinball/vector/blob/main/src/common/backend.py#L449)
...
- **Handler:** [`app_game_config_filename`](https://github.com/warped-pinball/vector/blob/main/src/common/backend.py#L468)
...
- **Handler:** [`app_game_configs_list`](https://github.com/warped-pinball/vector/blob/main/src/common/backend.py#L494)
...
- **Handler:** [`app_game_status`](https://github.com/warped-pinball/vector/blob/main/src/common/backend.py#L523)
...
- **Handler:** [`app_getLogs`](https://github.com/warped-pinball/vector/blob/main/src/common/backend.py#L1721)
- Authentication: Required (see [Authentication guide](authentication.md)).
- Cooldown: 10s
- Single instance: Yes
...
- **Handler:** [`app_list_available_formats`](https://github.com/warped-pinball/vector/blob/main/src/common/backend.py#L1746)
...
- **Handler:** [`app_set_current_format`](https://github.com/warped-pinball/vector/blob/main/src/common/backend.py#L1784)
- Authentication: Required (see [Authentication guide](authentication.md)).
...
- **Handler:** [`app_get_active_formats`](https://github.com/warped-pinball/vector/blob/main/src/common/backend.py#L1829)
...
- **Handler:** [`app_get_switch_diagnostics`](https://github.com/warped-pinball/vector/blob/main/src/common/backend.py#L1869)
...
- **Handler:** [`app_updates_available`](https://github.com/warped-pinball/vector/blob/main/src/common/backend.py#L1895)
- Cooldown: 10s
...
- **Handler:** [`app_apply_update`](https://github.com/warped-pinball/vector/blob/main/src/common/backend.py#L1930)
- Authentication: Required (see [Authentication guide](authentication.md)).
...
- **Handler:** [`app_inAPMode`](https://github.com/warped-pinball/vector/blob/main/src/common/backend.py#L1983)
...
- **Handler:** [`app_inAPMode`](https://github.com/warped-pinball/vector/blob/main/src/common/backend.py#L2006)
...
- **Handler:** [`app_setWifi`](https://github.com/warped-pinball/vector/blob/main/src/common/backend.py#L2011)
...
- **Handler:** [`app_getAvailableSSIDs`](https://github.com/warped-pinball/vector/blob/main/src/common/backend.py#L2062)
