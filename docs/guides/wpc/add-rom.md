...
- Putting the board back into Wi-Fi setup mode (hold the black button while powering up until it blinks fast) and reading the IP at the bottom of the AP screen on your phone.
...
Once connected, follow these steps to capture the memory images needed to build a new profile.  "GameName" can be an abbreviation.
...
'GameName_3player_ball3_player1up_435346_34563_45550.txt'
It helps if you save files with various players up and various numbers of players in the game.  Also try to store somethign with Ball 1,2 and 3
...
11. Email all files plus the game software version (shown on power-up) to [roms@WarpedPinball.com](mailto:roms@WarpedPinball.com).
