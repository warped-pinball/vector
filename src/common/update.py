from rsa_verify import verify_pkcs1v15_sha256
...
_UPDATE_PUBLIC_KEY_N = int(
    ""
)
_UPDATE_PUBLIC_KEY_E = 65537
...
def validate_signature():
    ...
    if not verify_pkcs1v15_sha256(hash_bytes, signature, _UPDATE_PUBLIC_KEY_N, _UPDATE_PUBLIC_KEY_E):
